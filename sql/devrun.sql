...
ALTER TABLE ORDER_LOG DROP COLUMN PREV_DETAIL_NO;
ALTER TABLE ORDER_LOG DROP COLUMN CURR_DETAIL_NO;
ALTER TABLE ORDER_LOG ADD PREV_DETAIL_NO VARCHAR2(500);
ALTER TABLE ORDER_LOG ADD CURR_DETAIL_NO VARCHAR2(500);
