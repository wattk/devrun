...
CREATE TABLE "PROMOTION" (
	...
	"VAILD_DATES" NUMBER NOT NULL,
	"SIDE_NOTE" VARCHAR(500)	 NOT NULL,
	"IS_REGULAR"	CHAR(1) DEFAULT 'N'	NOT NULL,
...
-- IS_REGULAR 컬럼 데이터타입 INT로 변경
ALTER TABLE PROMOTION DROP COLUMN IS_REGULAR;
ALTER TABLE PROMOTION ADD (IS_REGULAR NUMBER);
ALTER TABLE PROMOTION DROP CONSTRAINT CK_PROMOTION_IS_REGULAR;
ALTER TABLE PROMOTION ADD CONSTRAINT CK_PROMOTION_IS_REGULAR CHECK(IS_REGULAR IN(0,1));
-- 등록일 컬럼 추가
ALTER TABLE PROMOTION ADD (ENROLL_DATE DATE DEFAULT SYSDATE);
...
COMMENT ON COLUMN "PROMOTION"."VAILD_DATES" IS '진행기간';
