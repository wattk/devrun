					...
					<nav id="mycommunityTab" class="col-12">
						<ul class="nav nav-tabs col-11">
							<li class="nav-item col-5">
								<a href="${pageContext.request.contextPath}/mypage/mycommunity/postList.do" id="postListTab" class="nav-link bi bi-journal-text"> 내가 쓴 글</a>
							</li>
							<li class="nav-item col-5">
								<a href="" id="likeListTab" class="nav-link active bi bi-heart"> 좋아요</a>
							</li>
						</ul>
					</nav>
...
$("#selectType select").change(function(e){
	...
	$.ajax({
		url : `${pageContext.request.contextPath}/mypage/mycommunity/selectLikeList/\${selectType}`,
		constentType : "application/json; charset=utf-8",
		success(data){
			//console.log(data);
			const $tbody = $("tbody");
			$tbody.children().remove();
			$tbody.html(data["likeListStr"]);
